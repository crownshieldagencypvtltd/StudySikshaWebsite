  ...
  const data = [
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Shiksha Yogya was founded with a mission to provide quality education consultancy services to students
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Expanded our services to include more study destinations and established partnerships with over 200
            universities worldwide.
          </p>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Opened new offices in major cities across India to better serve our growing student base.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-4">
            Celebrated our 10th anniversary with over 5,000 successful student placements in top universities worldwide.
          </p>
          <div className="mb-8">
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ Launched digital counseling platform
            </div>
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ Expanded to 50+ countries for study destinations
            </div>
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ Established scholarship fund for deserving students
            </div>
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ Achieved 98% visa success rate
            </div>
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ Recognized as the best education consultancy in India
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <Image
